...
export const WHITELIST_TOKEN: {[symbol: string]: {address: string, decimals: number, chainId: ChainId}} = {
    ...
    USDT: {address: '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9', decimals: 18, chainId: ChainId.ARBITRUM_MAINNET},
    ETH: {address: NATIVE_ADDRESS, decimals: 18, chainId: ChainId.ARBITRUM_MAINNET},
    BTC: {address: NATIVE_ADDRESS, decimals: 8, chainId: ChainId.BTC_MAINNET}
}
